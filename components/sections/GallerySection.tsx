  ...
  return (
    <section className="section-space bg-zinc-950">
      <Container>
        ...
        <div className={`-mx-5 mt-8 flex snap-x snap-mandatory gap-4 overflow-x-auto px-5 pb-3 sm:mx-0 sm:grid sm:overflow-visible sm:px-0 ${items.length === 1 ? "sm:max-w-2xl sm:grid-cols-1" : "sm:grid-cols-2 lg:grid-cols-3"}`}>
