        ...
        <div className="rounded-3xl border border-white/10 bg-[radial-gradient(circle_at_top_right,rgba(239,43,35,0.18),transparent_35%)] p-7 sm:p-12 lg:p-16">
          <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-extrabold uppercase leading-tight text-white sm:text-5xl">{content.titleLines.map((line, index) => <span key={line} className={index === content.titleLines.length - 1 ? "block text-gradient" : "block"}>{line}</span>)}</h2>
